    ...
    IEquatable<ExprNode>
{
    ...
    public Option<int> IsIndex => _obj.Is<int>().AsOption();

    public Option<string> IsName => _obj.Is<string>().AsOption();

    public Option<ParameterExpression> IsParameter => _obj.Is<ParameterExpression>().AsOption();
