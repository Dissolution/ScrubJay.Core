    ...
    where B : FluentBodyBuilder<B>
{
    ...
    public Expression Call(MethodInfo staticMethod, params ExprNode[] parameters)
    {
    ...
    public Expression Call(MethodInfo staticMethod, IReadOnlyList<ParameterExpression> parameters)
    {
        if (!staticMethod.IsStatic)
            throw new ArgumentException(null, nameof(staticMethod));
