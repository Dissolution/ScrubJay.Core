...
//
//public interface IPooledSet<T> : IPooled,
...
//}
//
//public class PooledSet<T> : IPooledSet<T>
//{
...
//#region Constructors
//
//    public PooledSet() : this((IEqualityComparer<T>?)null)
//    {
//    }
//
...
//    }
//
//    public PooledSet(int capacity) : this(capacity, null)
//    {
//    }
//
//
//    public PooledSet(int capacity, IEqualityComparer<T>? comparer) : this(comparer)
//    {
//        if (capacity < 0)
//        {
...
//        if (other is HashSet<T> otherAsSet && EqualityComparersAreEqual(this, otherAsSet))
//        {
//            SymmetricExceptWithUniquePooledSet(otherAsSet);
//        }
//        else
//        {
...
//    private void SymmetricExceptWithUniquePooledSet(HashSet<T> other)
//    {
//        foreach (T item in other)
//        {
//            if (!Remove(item))
